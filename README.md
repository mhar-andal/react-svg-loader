...
When making updates, create a branch and commit to that. You should not bump `package.json` manually, or update the CHANGELOG.md within your branch. Once complete, issue a PR to merge into master. Instead, once the PR has been approved and merged, do the following...
